...
router.route('/:userId/invoices/new').get(checkToken, isAdmin, getNewInvoice);
router.route('/:userId/invoices/accept').get(checkToken, isAdmin, getAcceptInvoice);
router.route('/:userId/invoices/cancel').get(checkToken, isAdmin, getCancelInvoice);
